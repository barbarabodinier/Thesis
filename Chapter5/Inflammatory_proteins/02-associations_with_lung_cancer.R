...
# Saving the results
saveRDS(stab, "Results/Inflammatory_proteins/Multivariate_lung_cancer.rds")
saveRDS(expl, "Results/Inflammatory_proteins/Incremental_performances_lung_cancer.rds")
